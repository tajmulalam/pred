...
<script src="https://raw.githubusercontent.com/nimiq/qr-scanner/master/qr-scanner.min.js"></script>
<script type="module">
    ...
    scanner.start();
    document.getElementById("qrcode").value = scanner;
...
<center>
    <form>
        QR Code Data: <input type="text" id='qrcode'>
    </form>
</center>
